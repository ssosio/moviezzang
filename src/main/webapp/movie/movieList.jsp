...
<script>
	function searchMovies(){
	    ...
	    $.get("/movie/movieSearch.jsp", { keyword }, function(data){    	
	        ...
	        $("div.mListHeader>span").text(count + "개의 영화가 검색되었습니다");
	    });
	}
</script>
<body>
	<div class="mListContainer">
		<div class="mListHeader">	
			...
			<div class="mSearch">	
				...
				<button type="button" id="btnMovieSearch"><i class="bi bi-search"></i></button>	    		
			</div>
		</div>
		<script>
			...
			<div class="mCard poster relative flex-shrink-0 w-64">
				...
				<div class="mt-3">
					...
					<div class="flex items-center text-sm text-gray-600 mt-1">
						<span>예매율${i} </span> <span class="mx-2">|</span> 
						<span><%=dto.getRelease_date()%></span>
					</div>
				</div>
			</div>
			<%
