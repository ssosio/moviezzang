  ...
  <div class="absolute inset-0 flex items-center z-20">
    <div class="container mx-auto px-4">
      ...
      <div class="flex space-x-4">
        <button class="bg-primary text-white px-6 py-3 !rounded-button whitespace-nowrap hover:bg-opacity-90 transition-colors">
          상세정보
        </button>
        <button class="bg-white text-primary px-6 py-3 !rounded-button whitespace-nowrap hover:bg-opacity-90 transition-colors">
          예매하기
        </button>
      </div>
    </div>
